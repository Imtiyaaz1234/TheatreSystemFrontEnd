    ...
    <body>
        ...
        <div class="webdesigntuts-workshop" id="search" style="display:none">
            <form action="/home" method="POST">
                ...
                <select name="option">
                    <option value="viewClient">View client information</option>
                    <option value="editClient">Edit client information</option>
                    <option value="viewAccount">View account information</option>
                    <option value="editAccount">Edit account information</option>
                    <option value="deleteAccount">Delete account information</option>
                </select>
